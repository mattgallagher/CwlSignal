...
extension Signal {
	public final func join(to: SignalMergeSet<T>, closesOutput: Bool = false, removeOnDeactivate: Bool = false) {
		to.add(self, closesOutput: closesOutput, removeOnDeactivate: removeOnDeactivate)
	}
}
