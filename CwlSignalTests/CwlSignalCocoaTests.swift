...
class SignalCocoaTests: XCTestCase {
	...
	func testSignalFromNotifications() {
		...
		NotificationCenter.default.post(name: Notification.Name.NSAntialiasThresholdChanged, object: source)
		NotificationCenter.default.post(name: Notification.Name.NSAnimationProgressMark, object: source)
		XCTAssert(results == ["\(Notification.Name.NSAntialiasThresholdChanged)", "\(Notification.Name.NSAnimationProgressMark)"])
		ep.cancel()
	}
}
